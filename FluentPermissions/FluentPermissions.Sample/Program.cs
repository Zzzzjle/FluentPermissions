...
public static class Program
{
    ...
    Console.WriteLine($"Group: {system.LogicalName}, Display: {system.DisplayName}, FullName: {system.FullName}, Key: {system.Key}, Icon: {system.Icon}, Order: {system.DisplayOrder}, Desc: {system.Description}");

    var users = AppPermissions.System.Users.Group;
    Console.WriteLine($"Child Group: {users.LogicalName}, Display: {users.DisplayName}, FullName: {users.FullName}, Key: {users.Key}");

    var create = AppPermissions.System.Users.Create;
    var delete = AppPermissions.System.Users.Delete;
    Console.WriteLine($"Perm: {create.FullName}, Display: {create.DisplayName}, Key: {create.Key}, Desc: {create.Description}");
    Console.WriteLine($"Perm: {delete.FullName}, Display: {delete.DisplayName}, Key: {delete.Key}, Desc: {delete.Description}, HighRisk: {delete.IsHighRisk}");
        ...
        // 导航关系
    Console.WriteLine($"Users.GroupKey == System.Key? {string.Equals(users.Key, system.Key, StringComparison.Ordinal)}");
